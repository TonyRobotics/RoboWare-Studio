...
import { RosService } from 'vs/workbench/services/ros/node/rosService';
import { ICmakeService } from 'vs/platform/ros/common/cmake';
import { CmakeService } from 'vs/workbench/services/ros/node/cmakeService';
...
export class WorkbenchShell {
	...
	private initServiceCollection(container: HTMLElement): [IInstantiationService, ServiceCollection] {
		...
		const rosService = instantiationService.createInstance(RosService);
		serviceCollection.set(IRosService, rosService);

		const cmakeService = instantiationService.createInstance(CmakeService);
		serviceCollection.set(ICmakeService, cmakeService);
