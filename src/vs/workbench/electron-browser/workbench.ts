...
import { RosService } from 'vs/workbench/services/ros/electron-browser/rosService';
import { IRosWinService } from 'vs/platform/ros/common/ros';
...
export class Workbench implements IPartService {
	...
	private initServices(): void {
		...
		// Ros Service
		const rosebService = this.instantiationService.createInstance(RosService);
		serviceCollection.set(IRosWinService, rosebService);
