...
configurationRegistry.registerConfiguration({
	...
	'properties': {
		'files.exclude': {
			...
			'default': {
				'**/.git': true, '**/.svn': true, '**/.hg': true, '**/CVS': true, '**/.DS_Store': true, '**/.vscode': true,
				'build': true, 'build_isolated': true, 'devel': true, 'devel_isolated': true, 'el': true, 'el_isolated': true,
				'logs': true, '.catkin_tools': true, '**/.ycm_extra_conf.*': true
			},
