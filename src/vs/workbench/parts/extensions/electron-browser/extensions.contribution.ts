...
import { IExtensionGalleryService, IExtensionTipsService, ExtensionsLabel, ExtensionsChannelId } from 'vs/platform/extensionManagement/common/extensionManagement';	// 注意，删掉了PreferencesLabel
...
import { IExtensionsWorkbenchService } from '../common/extensions';	// 注意，删掉了VIEWLET_ID
...
import { ToggleVimAction } from 'vs/workbench/parts/extensions/browser/extensionsActions';
...
const toggleVimAction = new SyncActionDescriptor(ToggleVimAction, ToggleVimAction.ID, ToggleVimAction.LABEL);
actionRegistry.registerWorkbenchAction(toggleVimAction, `Extensions: Toggle Vim Mode`, ExtensionsLabel);
