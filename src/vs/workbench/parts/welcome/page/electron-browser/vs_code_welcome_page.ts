...
<div class="welcomePageContainer">
	<div class="welcomePage">
		<div class="title">
			<h1>${escape(localize('welcomePage.vscode', "RoboWare Studio"))}</h1>
			<p class="subtitle">${escape(localize('welcomePage.designForROS', "Design for ROS"))}</p>
		</div>
		<div class="row">
			<div class="splash">
				<div class="section start">
					...
					<ul>
						<li><a href="command:workbench.action.files.newWorkspace">${escape(localize('welcomePage.newWorkspace', "New Workspace..."))}</a></li>
						<li class="mac-only"><a href="command:workbench.action.files.openFileFolder">${escape(localize('welcomePage.openFolder', "Open Workspace..."))}</a></li>
						<li class="windows-only linux-only"><a href="command:workbench.action.files.openFolder">${escape(localize('welcomePage.openFolder', "Open Workspace..."))}</a></li>
