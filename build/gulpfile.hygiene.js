...
const eolFilter = [
	...
	'!**/node_modules/**',
	'!**/fixtures/**',
	'!**/*.{svg,exe,png,bmp,scpt,bat,cmd,cur,ttf,woff,eot,node}',
	...
	'!nm_arch/**',
	'!data/**',
	'!src/vs/workbench/parts/rpm/**',
	'!src/vs/workbench/parts/community/**',
	'!src/vs/rw/**'
];
...
const hygiene = exports.hygiene = (some, options) => {
	...
	const copyrights = es.through(function (file) {
		if (file.contents.toString('utf8').indexOf(copyrightHeader) !== 0 && file.contents.toString('utf8').indexOf(copyrightHeader2) !== 0) {
