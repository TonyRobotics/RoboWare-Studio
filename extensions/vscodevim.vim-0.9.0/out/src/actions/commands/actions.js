...
let PutCommandVisual = class PutCommandVisual extends BaseCommand {
    ...
    exec(position, vimState, after = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (register.registerMode === register_1.RegisterMode.LineWise) {
                let result = yield new operator.DeleteOperator(this.multicursorIndex).run(vimState, start, end, false);
            ...
            result.recordedState.registerName = configuration_1.Configuration.useSystemClipboard ? '*' : '"';
