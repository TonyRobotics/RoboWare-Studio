...
class Register {
    ...
    static ProcessNumberedRegister(content, vimState) {
        ...
        const baseOperator = vimState.recordedState.actionsRun.find((value) => {
            return value instanceof operator_1.BaseOperator ||
        ...
        else if (baseOperator instanceof operator_1.DeleteOperator && !(vimState.isRecordingMacro || vimState.isReplayingMacro)) {
